  ...
  <div>
      ...
      <nav class="main-header" role="navigation">
        <div class="header-container">
          <a class="logo" href="/" aria-label="بازگشت به صفحه اصلی">
...
useHead({
  ...
  title: 'تست OTP سیگنال',
  meta: [
    { name: 'description', content: 'تست آنلاین OTP سیگنال: ارسال و تأیید کد یکبار مصرف با پیامک یا تماس بی\u200cپاسخ.' }
  ],
  link: [
...
<style>
    .page-wrapper {
      ...
      background:
        radial-gradient(circle at 18% 18%, rgba(20, 184, 166, 0.08), transparent 38%),
        linear-gradient(180deg, #f8fafc 0%, #f1f5f9 100%);
      overflow-x: hidden;
      font-family: "IRANSansX", "AbarLowFaNum", sans-serif;
    }
    ...
    * {
    ...
    .test-card::before {
      ...
      left: -120px;
      border-radius: 50%;
      background: radial-gradient(circle, rgba(20, 184, 166, 0.1), transparent 72%);
      pointer-events: none;
    }
    ...
    .test-card::after {
      ...
      right: -90px;
      border-radius: 50%;
      background: radial-gradient(circle, rgba(249, 115, 22, 0.08), transparent 72%);
      pointer-events: none;
    }
    ...
    .phone-input-group:focus-within {
      border-color: #7accc7;
      box-shadow: 0 0 0 3px rgba(20, 184, 166, 0.15), inset 0 1px 4px rgba(15, 23, 42, 0.03);
    }
